...
sub get_elem(rib_ptr, index)
    local tab_index
    tab_index = safe_shr(rib_ptr,1)
    if tab_index >= 26214400 then
        local memory_no
        memory_no = (tab_index/26214400)
        tab_index = tab_index - (memory_no*26214400)
        switch memory_no
            case 1
                return memory2(tab_index, index)
            case 2
                return memory3(tab_index, index)
            case 3
                return memory4(tab_index, index)
            case 4
                return memory5(tab_index, index)
            case 5
                return memory6(tab_index, index)
            case 6
                return memory7(tab_index, index)
            case 7
                return memory8(tab_index, index)
            case 8
                return memory9(tab_index, index)
            case 9
                return memory10(tab_index, index)
            case 10
                return memory11(tab_index, index)
            case 11
                return memory12(tab_index, index)
            case 12
                return memory13(tab_index, index)
            case 13
                return memory14(tab_index, index)
            case 14
                return memory15(tab_index, index)
            case 15
                return memory16(tab_index, index)
            case 16
                return memory17(tab_index, index)
            case 17
                return memory18(tab_index, index)
            case 18
                return memory19(tab_index, index)
            case 19
                return memory20(tab_index, index)
        end switch
    fi
    return memory(tab_index, index)
end sub

sub augment_memory()
    if memory_size >= 26214400 then
        memory_no = (memory_size/26214400)
        memory_size = memory_size + 26214400
        switch memory_no
            case 1
                dim memory2(26214400,2)
                return 1
            case 2
                dim memory3(26214400,2)
                return 1
            case 3
                dim memory4(26214400,2)
                return 1
            case 4
                dim memory5(26214400,2)
                return 1
            case 5
                dim memory6(26214400,2)
                return 1
            case 6
                dim memory7(26214400,2)
                return 1
            case 7
                dim memory8(26214400,2)
                return 1
            case 8
                dim memory9(26214400,2)
                return 1
            case 9
                dim memory10(26214400,2)
                return 1
            case 10
                dim memory11(26214400,2)
                return 1
            case 11
                dim memory12(26214400,2)
                return 1
            case 12
                dim memory13(26214400,2)
                return 1
            case 13
                dim memory14(26214400,2)
                return 1
            case 14
                dim memory15(26214400,2)
                return 1
            case 15
                dim memory16(26214400,2)
                return 1
            case 16
                dim memory17(26214400,2)
                return 1
            case 17
                dim memory18(26214400,2)
                return 1
            case 18
                dim memory19(26214400,2)
                return 1
            case 19
                dim memory20(26214400,2)
                return 1
            default:
...
sub alloc_memory(rib_0, rib_1, rib_2)
    ...
    if memory_size >= 26214400 then
        memory_no = (memory_size/26214400)
        local index
        index = top_memory - (memory_no*26214400)

        switch memory_no
            case 1
                memory2(index,0) = rib_0
                memory2(index,1) = rib_1
                memory2(index,2) = rib_2
                return top_memory * 2 + 1
            case 2
                memory3(index,0) = rib_0
                memory3(index,1) = rib_1
                memory3(index,2) = rib_2
                return top_memory * 2 + 1
            case 3
                memory4(index,0) = rib_0
                memory4(index,1) = rib_1
                memory4(index,2) = rib_2
                return top_memory * 2 + 1
            case 4
                memory5(index,0) = rib_0
                memory5(index,1) = rib_1
                memory5(index,2) = rib_2
                return top_memory * 2 + 1
            case 5
                memory6(index,0) = rib_0
                memory6(index,1) = rib_1
                memory6(index,2) = rib_2
                return top_memory * 2 + 1
            case 6
                memory7(index,0) = rib_0
                memory7(index,1) = rib_1
                memory7(index,2) = rib_2
                return top_memory * 2 + 1
            case 7
                memory8(index,0) = rib_0
                memory8(index,1) = rib_1
                memory8(index,2) = rib_2
                return top_memory * 2 + 1
            case 8
                memory9(index,0) = rib_0
                memory9(index,1) = rib_1
                memory9(index,2) = rib_2
                return top_memory * 2 + 1
            case 9
                memory10(index,0) = rib_0
                memory10(index,1) = rib_1
                memory10(index,2) = rib_2
                return top_memory * 2 + 1
            case 10
                memory11(index,0) = rib_0
                memory11(index,1) = rib_1
                memory11(index,2) = rib_2
                return top_memory * 2 + 1
            case 11
                memory12(index,0) = rib_0
                memory12(index,1) = rib_1
                memory12(index,2) = rib_2
                return top_memory * 2 + 1
            case 12
                memory13(index,0) = rib_0
                memory13(index,1) = rib_1
                memory13(index,2) = rib_2
                return top_memory * 2 + 1
            case 13
                memory14(index,0) = rib_0
                memory14(index,1) = rib_1
                memory14(index,2) = rib_2
                return top_memory * 2 + 1
            case 14
                memory15(index,0) = rib_0
                memory15(index,1) = rib_1
                memory15(index,2) = rib_2
                return top_memory * 2 + 1
            case 15
                memory16(index,0) = rib_0
                memory16(index,1) = rib_1
                memory16(index,2) = rib_2
                return top_memory * 2 + 1
            case 16
                memory17(index,0) = rib_0
                memory17(index,1) = rib_1
                memory17(index,2) = rib_2
                return top_memory * 2 + 1
            case 17
                memory18(index,0) = rib_0
                memory18(index,1) = rib_1
                memory18(index,2) = rib_2
                return top_memory * 2 + 1
            case 18
                memory19(index,0) = rib_0
                memory19(index,1) = rib_1
                memory19(index,2) = rib_2
                return top_memory * 2 + 1
            case 19
                memory20(index,0) = rib_0
                memory20(index,1) = rib_1
                memory20(index,2) = rib_2
                return top_memory * 2 + 1
            default
                print "Memory limit reached"
                exit
